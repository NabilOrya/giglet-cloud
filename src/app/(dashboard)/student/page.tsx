    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-gray-200 dark:border-gray-800 shadow-sm">
          <h3 className="text-gray-500 text-sm font-medium mb-1">Active Gigs</h3>
      ...
      <div className="mt-10 p-10 bg-blue-600 rounded-3xl text-white text-center">
        <h2 className="text-2xl font-bold mb-2">Welcome to Phase 1!</h2>
        <p className="opacity-90">Your student account is active. Gig marketplace features are coming soon.</p>
      </div>
    </div>
  )
}
